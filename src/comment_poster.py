...
class CommentPoster:
    ...
    def __init__(self, credentials_file: str = "credentials.json", 
        ...
        self.youtube = None
        self.rate_limiter = RateLimiter(max_calls=100, time_window=100)  # YouTube API 제한
    ...
    def generate_contextual_comment(self, video_info: Dict, comment_type: str = "positive") -> str:
        """맥락에 맞는 댓글 생성"""
        templates = self.comment_templates.get(comment_type, self.comment_templates["positive"])
    ...
    def auto_comment_on_video(self, video_id: str) -> List[str]:
        ...
        for i in range(max_comments):
            try:
                ...
                # 댓글 생성
                comment_text = self.generate_contextual_comment(video_info, comment_type)
