...
def get_initial_credentials():
    ...
    client_secrets_file_path = 'youtube_client_secrets.json' # <--- 이 파일 이름을 정확히 확인하세요!
    ...
    flow = InstalledAppFlow.from_client_secrets_file(
        client_secrets_file_path, SCOPES, redirect_uri='urn:ietf:wg:oauth:2.0:oob' # <--- OOB 리디렉션 URI 사용
    )
